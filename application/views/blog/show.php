...
if (empty($blog['cover'])) {
	...
	$cover = base_url("assets/assets/covers/") . $blog['cover'];
}
?>
		...
		<div class="row gx-4 gx-lg-5 justify-content-center">
			<div class="col-md-10 col-lg-8 col-xl-7">
				<div class="post-heading">
					...
					<h2 class="subheading"><?php echo $blog['url'] ?></h2>
					<span class="meta">
						Posted by
						<a href="#!">Start Bootstrap</a>
						on <?php echo date('d F Y', strtotime($blog['date'])) ?>
					</span>
				</div>
			</div>
		</div>
...
<article class="mb-4">
	<div class="container px-4 px-lg-5">
		<div class="row gx-4 gx-lg-5 justify-content-center">
			<div class="col-md-10 col-lg-8 col-xl-7">
				<p style="white-space: pre-line; text-align: justify;"><?php echo $blog['content']; ?></p>
				...
				<p>As we got further and further away, it [the Earth] diminished in size. Finally it shrank to the size of a
					...
					man.</p>
				<a href="#!"><img class="img-fluid" src="<?php echo base_url('assets/assets/img/post-sample-image.jpg'); ?>"
						alt="..." /></a>
...
<body>
	<h1>Show Blog dengan Id <?php echo $blog['id'] ?> </h1>
	<h2>
		<?php echo $blog['title'] ?>
	</h2>
	<p>
